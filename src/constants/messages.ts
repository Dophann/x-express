export const USER_MESSAGES = {
  ...
  USERNAME_MUST_BE_AT_LEAST_2_AND_MAX_15_CHARACTERS: 'Username must be at least 2 and at most 15 characters',
  ...
  USER_INVALID_FORMAT:
    'Username must be 2–15 characters long and only contain letters, numbers, or underscores (no spaces)',
  ...
  UNFOLLOW_FAILED: 'Unfollow user failed',
